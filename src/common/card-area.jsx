...
const card_content = {
  ...
  title: (
    <>
      Unlock <span>End-to-End Solutions</span> for Your Organization
    </>
  ),
  description: (
    <>
      From governance to digital transformation, our tailored services help you
      overcome challenges and seize opportunities. <br />
      Partner with us to drive growth and sustainability in every sector.
    </>
  ),
