...
const business_content = {
  ...
  sub_title: "All-in-one Business Consultant",
  title: (
    <>
      Transforming Visions into <br /> <span>Reality</span>{" "}
    </>
  ),
...
const BusinessBox = () => {
  return (
    <>
      <div className="tp-cta-area pt-120 pb-120 mt-50 mb-90 tp-cta-five-bg p-relative">
            ...
            <div className="col-12">
              <div className="tp-cta-five-section-box text-center">
                ...
                <div className="tp-cta-five-btn">
                  <Link
                    className="tp-btn-grey mb-20 circle-effect"
                    href="/contact"
                  >
                    {btn_text}
                  </Link>
